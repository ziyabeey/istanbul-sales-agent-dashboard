...
const SLUG = 'giris-sorunlari'

export const metadata: Metadata = {
  title: 'Giriş Sorunları | KPNK Sorun Giderme',
  description: 'OTP kodu gelmemesi, süre dolması, hesap bulunamadı ve giriş kısıtlama çözümleri.',
