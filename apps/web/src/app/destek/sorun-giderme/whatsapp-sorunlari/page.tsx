...
const SLUG = 'whatsapp-sorunlari'

export const metadata: Metadata = {
  title: 'WhatsApp Sorunları | KPNK Sorun Giderme',
  description: 'WhatsApp AI asistan, mesaj, kredi ve gecikme sorunları için çözümler.',
