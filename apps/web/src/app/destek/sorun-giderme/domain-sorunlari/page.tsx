...
const SLUG = 'domain-sorunlari'

export const metadata: Metadata = {
  title: 'Domain Sorunları | KPNK Sorun Giderme',
  description: 'DNS yayılma, SSL sertifikası, www yönlendirmesi ve domain bağlama çözümleri.',
