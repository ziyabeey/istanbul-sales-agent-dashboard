...
const SLUG = 'editor-sorunlari'

export const metadata: Metadata = {
  title: 'Editör Sorunları | KPNK Sorun Giderme',
  description: 'Kaydetme hataları, blok yükleme ve görsel yükleme sorunları için çözümler.',
