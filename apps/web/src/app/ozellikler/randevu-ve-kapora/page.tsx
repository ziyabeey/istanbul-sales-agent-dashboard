        ...
        <main className="min-h-screen bg-background pt-32 pb-24 text-foreground">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-32 flex flex-col md:flex-row items-center gap-12">
                ...
                <div className="flex-1 w-full space-y-6">
                    ...
                    <p className="text-muted-foreground">Uygulamanız arka planda gerçek bir pos cihazı gibi çalışır. Yüksek tutarlı çekimlerde veya ilk kez gelen müşterilerde AI inisiyatif alıp ödeme tahsil edilmeden koltuğu ayırmaz.</p>
