                    ...
                    <div className="flex flex-col gap-4">
                        <div className="bg-sage/10 border border-sage/20 rounded-xl p-4 flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-muted-foreground-light text-sm mt-1">"Köfteci Yusuf - 450 TL" %1 KDV ile masraf merkezine işlendi ve muhasebecinize Luca üzerinden iletildi.</p>
                            </div>
                        </div>
                        <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex items-start gap-4 opacity-70">
                            <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center text-2xl">⚡</div>
                            <div className="flex-1">
                                <h4 className="text-white font-bold">Taslak E-Fatura Oluşturuldu</h4>
                                <p className="text-muted-foreground-light text-sm mt-1">Ahmet Turizm A.Ş. için 12.000 TL değerinde hizmet faturası e-Arşiv'de imzalanmayı bekliyor.</p>
                            </div>
                        </div>
                    </div>
                </DashboardMockup>
