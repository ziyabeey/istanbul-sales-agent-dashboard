        ...
        <>
            ...
            <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-foreground tracking-tight mb-6 font-syne">
                    Görünmez <span className="text-rust">Ordunuz</span>
                </h1>
                <p className="font-lora italic text-xl text-muted-foreground-light max-w-3xl mx-auto leading-relaxed">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                                kepenk.ai'nin <strong className="text-foreground">Multi-Agent (Çoklu Ajan) mimarisi</strong> sayesinde işler eşzamanlı yürür. Müşteriye WhatsApp'tan dönen ajan başkadır, o veriyi alıp web sitenizi güncelleyen ajan başkadır. Hepsi birbiriyle saniyesinde iletişim kurar.
                            </p>
                            <ul className="space-y-4 font-bold text-foreground">
                                <li className="flex items-center gap-3"><span className="w-8 h-8 rounded-full bg-rust/10 flex items-center justify-center text-rust">1</span> 7/24 Kesintisiz Operasyon</li>
                                <li className="flex items-center gap-3"><span className="w-8 h-8 rounded-full bg-rust/10 flex items-center justify-center text-rust">2</span> İnsana Özgü Hata Payı Sıfır</li>
                                <li className="flex items-center gap-3"><span className="w-8 h-8 rounded-full bg-rust/10 flex items-center justify-center text-rust">3</span> Şirket İçi Veri Sızıntısı Riski Yok (256-Bit TLS)</li>
                            </ul>
                        </div>
                        <div className="bg-warm rounded-3xl p-8 border border-border/20 relative">
                            ...
                            <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-rust rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
                        </div>
                    </div>
                </div>
            </section>
