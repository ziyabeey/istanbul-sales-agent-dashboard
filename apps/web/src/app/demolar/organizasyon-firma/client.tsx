...
import {
  ThemeRenderer,
  ORGANIZASYON_FIRMA_CONFIG,
  ORGANIZASYON_FIRMA_BUSINESS
} from '@kepenk/templates'

export default function OrganizasyonFirmaClient() {
  const theme = ORGANIZASYON_FIRMA_CONFIG;
  const business = ORGANIZASYON_FIRMA_BUSINESS;
