...
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, PharmacyServicesGrid as _psg, PharmacyProductCards as _ppc, PharmacyDutyInfo as _pdi, PharmacyStatsRow as _psr, PharmacyContactForm as _pcf, ThemeRenderer, ECZANE_MAHALLE_CONFIG, ECZANE_MAHALLE_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _psg; void _ppc; void _pdi; void _psr; void _pcf
export default function Client() {
  const theme = ECZANE_MAHALLE_CONFIG;
  const business = ECZANE_MAHALLE_BUSINESS;

  const t = ECZANE_MAHALLE_CONFIG, p = t.pages[0]!, b = ECZANE_MAHALLE_BUSINESS
