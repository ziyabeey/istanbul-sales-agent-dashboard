...
import {
  ...
  ThemeRenderer,
  GUZELLIK_ATELIER_CONFIG,
  GUZELLIK_ATELIER_BUSINESS,
...
export default function GuzellikAtelierClient() {
  const theme = GUZELLIK_ATELIER_CONFIG
  const page = theme.pages[0]!
  const business = GUZELLIK_ATELIER_BUSINESS
