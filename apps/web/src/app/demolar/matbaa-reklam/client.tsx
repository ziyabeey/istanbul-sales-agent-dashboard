...
import {
  ThemeRenderer,
  MATBAA_REKLAM_CONFIG,
  MATBAA_REKLAM_BUSINESS
} from '@kepenk/templates'

export default function MatbaaReklamClient() {
  const theme = MATBAA_REKLAM_CONFIG;
  const business = MATBAA_REKLAM_BUSINESS;
