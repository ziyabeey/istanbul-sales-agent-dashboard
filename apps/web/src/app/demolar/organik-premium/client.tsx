...
import {
  ...
  ThemeRenderer, ORGANIK_PREMIUM_CONFIG, ORGANIK_PREMIUM_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _psg; void _fss; void _fsr; void _ocf

export default function OrganikPremiumClient() {
  const theme = ORGANIK_PREMIUM_CONFIG; const page = theme.pages[0]!; const business = ORGANIK_PREMIUM_BUSINESS
  return (
    <div lang="tr">
