'use client'
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, BakeryMenuGrid as _bmg, BakeryStorySection as _bs, CakeGalleryGrid as _cg, BakeryStatsRow as _bsr, CakeOrderForm as _cof, ThemeRenderer, PASTANE_SIMIT_CONFIG, PASTANE_SIMIT_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _bmg; void _bs; void _cg; void _bsr; void _cof
export default function Client() {
  const t = PASTANE_SIMIT_CONFIG, p = t.pages[0]!, b = PASTANE_SIMIT_BUSINESS
