'use client'
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, MusicCourseGrid as _mcg, MusicTeacherGrid as _mtg, MusicPricingTable as _mpt, MusicStatsRow as _msr, MusicTrialForm as _mtf, ThemeRenderer, MUZIK_POP_CONFIG, MUZIK_POP_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _mcg; void _mtg; void _mpt; void _msr; void _mtf
export default function Client() {
  const t = MUZIK_POP_CONFIG, p = t.pages[0]!, b = MUZIK_POP_BUSINESS
