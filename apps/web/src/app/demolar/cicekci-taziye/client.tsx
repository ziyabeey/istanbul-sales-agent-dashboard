...
import {
  ThemeRenderer,
  CICEKCI_TAZIYE_CONFIG,
  CICEKCI_TAZIYE_BUSINESS
} from '@kepenk/templates'

export default function CicekciTaziyeClient() {
  const theme = CICEKCI_TAZIYE_CONFIG;
  const business = CICEKCI_TAZIYE_BUSINESS;
