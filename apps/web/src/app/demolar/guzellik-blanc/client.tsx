...
import {
  ...
  ThemeRenderer,
  GUZELLIK_BLANC_CONFIG,
  GUZELLIK_BLANC_BUSINESS,
...
export default function GuzellikBlancClient() {
  const theme = GUZELLIK_BLANC_CONFIG
  const page = theme.pages[0]!
  const business = GUZELLIK_BLANC_BUSINESS
