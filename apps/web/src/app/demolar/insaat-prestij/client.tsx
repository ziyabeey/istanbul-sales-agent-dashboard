...
export default function ClientPage() {
  const homePage = INSAAT_PRESTIJ_CONFIG.pages.find((p) => p.isHomePage);
  ...
  return (
    <ThemeProvider config={INSAAT_PRESTIJ_CONFIG}>
      <DemoNavigation 
        config={INSAAT_PRESTIJ_CONFIG} 
        businessData={INSAAT_PRESTIJ_BUSINESS} 
      />
