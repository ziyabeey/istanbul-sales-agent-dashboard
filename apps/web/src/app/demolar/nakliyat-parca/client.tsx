...
import {
  ThemeRenderer,
  NAKLIYAT_PARCA_CONFIG,
  NAKLIYAT_PARCA_BUSINESS
} from '@kepenk/templates'

export default function NakliyatParcaClient() {
  const theme = NAKLIYAT_PARCA_CONFIG;
  const business = NAKLIYAT_PARCA_BUSINESS;
