...
import {
  ThemeRenderer,
  PASTANE_VEGAN_CONFIG,
  PASTANE_VEGAN_BUSINESS
} from '@kepenk/templates'

export default function PastaneVeganClient() {
  const theme = PASTANE_VEGAN_CONFIG;
  const business = PASTANE_VEGAN_BUSINESS;
