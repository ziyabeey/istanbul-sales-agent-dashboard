'use client'
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, TailorServicesGrid as _tsg, FabricShowcase as _fs, TailorPortfolioGrid as _tpg, TailorStatsRow as _tsr, TailorBookingForm as _tbf, ThemeRenderer, TERZI_GELIN_CONFIG, TERZI_GELIN_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _tsg; void _fs; void _tpg; void _tsr; void _tbf
export default function Client() {
  const t = TERZI_GELIN_CONFIG, p = t.pages[0]!, b = TERZI_GELIN_BUSINESS
