'use client'
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, CoffeeMenuGrid as _cmg, CoffeeBeanShowcase as _cbs, CoffeeAtmosphere as _ca, CoffeeStatsRow as _csr, CoffeeOrderForm as _cof, ThemeRenderer, KAHVECI_3NESIL_CONFIG, KAHVECI_3NESIL_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _cmg; void _cbs; void _ca; void _csr; void _cof
export default function Client() {
  const t = KAHVECI_3NESIL_CONFIG, p = t.pages[0]!, b = KAHVECI_3NESIL_BUSINESS
