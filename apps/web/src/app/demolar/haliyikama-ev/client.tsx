...
import {
  ThemeRenderer,
  HALIYIKAMA_EV_CONFIG,
  HALIYIKAMA_EV_BUSINESS
} from '@kepenk/templates'

export default function HaliyikamaEvClient() {
  const theme = HALIYIKAMA_EV_CONFIG;
  const business = HALIYIKAMA_EV_BUSINESS;
