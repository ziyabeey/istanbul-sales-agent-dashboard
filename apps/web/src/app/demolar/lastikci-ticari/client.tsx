...
import { HeaderMinimalSticky as _h, FooterWarmColumns as _f, WhatsAppFloating as _wa, CookieBannerBottomBar as _c, TireServiceGrid as _tsg, TireBrandBar as _tbb, TirePricingTable as _tpt, TireStatsRow as _tsr, TireBookingForm as _tbf, ThemeRenderer, LASTIKCI_TICARI_CONFIG, LASTIKCI_TICARI_BUSINESS } from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _tsg; void _tbb; void _tpt; void _tsr; void _tbf
export default function Client() {
  const theme = LASTIKCI_TICARI_CONFIG;
  const business = LASTIKCI_TICARI_BUSINESS;

  const t = LASTIKCI_TICARI_CONFIG, p = t.pages[0]!, b = LASTIKCI_TICARI_BUSINESS
