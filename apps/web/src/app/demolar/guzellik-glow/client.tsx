...
import {
  ...
  ThemeRenderer,
  GUZELLIK_GLOW_CONFIG,
  GUZELLIK_GLOW_BUSINESS,
...
export default function GuzellikGlowClient() {
  const theme = GUZELLIK_GLOW_CONFIG
  const page = theme.pages[0]!
  const business = GUZELLIK_GLOW_BUSINESS
