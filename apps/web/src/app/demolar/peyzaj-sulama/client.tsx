...
import {
  ...
  LandscapePackages as _lp, GardenStatsRow as _gsr, ProjectPortfolioGrid as _ppg, GardenConsultForm as _gcf,
  ThemeRenderer, PEYZAJ_SULAMA_CONFIG, PEYZAJ_SULAMA_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _lp; void _gsr; void _ppg; void _gcf

export default function PeyzajSulamaClient() {
  const theme = PEYZAJ_SULAMA_CONFIG; const page = theme.pages[0]!; const business = PEYZAJ_SULAMA_BUSINESS
  return (
    <div lang="tr">
