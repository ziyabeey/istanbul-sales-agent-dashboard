...
import {
  ThemeRenderer,
  KRES_MONTESSORI_CONFIG,
  KRES_MONTESSORI_BUSINESS
} from '@kepenk/templates'

export default function KresMontessoriClient() {
  const theme = KRES_MONTESSORI_CONFIG;
  const business = KRES_MONTESSORI_BUSINESS;
