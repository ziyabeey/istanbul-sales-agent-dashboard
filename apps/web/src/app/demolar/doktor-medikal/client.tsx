...
import {
  HeaderMinimalSticky as _h, FooterWarmColumns as _f, StatsAnimatedRow as _stats,
  ...
  ThemeRenderer, DOKTOR_MEDIKAL_CONFIG, DOKTOR_MEDIKAL_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _stats; void _wa; void _c; void _dph; void _abw; void _ta; void _ilb; void _cgg

export default function DoktorMedikalClient() {
  const theme = DOKTOR_MEDIKAL_CONFIG; const page = theme.pages[0]!; const business = DOKTOR_MEDIKAL_BUSINESS
  return (
    <div lang="tr">
