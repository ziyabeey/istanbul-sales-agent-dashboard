...
import {
  ...
  ThemeRenderer, AVUKAT_AILE_CONFIG, AVUKAT_AILE_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _lpa; void _apc; void _lfaq; void _cw

export default function AvukatAileClient() {
  const theme = AVUKAT_AILE_CONFIG; const page = theme.pages[0]!; const business = AVUKAT_AILE_BUSINESS
  return (
    <div lang="tr">
