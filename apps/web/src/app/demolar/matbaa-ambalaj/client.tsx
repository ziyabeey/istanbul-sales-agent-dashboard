...
import {
  ThemeRenderer,
  MATBAA_AMBALAJ_CONFIG,
  MATBAA_AMBALAJ_BUSINESS
} from '@kepenk/templates'

export default function MatbaaAmbalajClient() {
  const theme = MATBAA_AMBALAJ_CONFIG;
  const business = MATBAA_AMBALAJ_BUSINESS;
