...
import {
  ThemeRenderer,
  ORGANIZASYON_KONSER_CONFIG,
  ORGANIZASYON_KONSER_BUSINESS
} from '@kepenk/templates'

export default function OrganizasyonKonserClient() {
  const theme = ORGANIZASYON_KONSER_CONFIG;
  const business = ORGANIZASYON_KONSER_BUSINESS;
