...
import {
  ...
  ThemeRenderer, AVUKAT_ADALET_CONFIG, AVUKAT_ADALET_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _lpa; void _apc; void _lfaq; void _cw

export default function AvukatAdaletClient() {
  const theme = AVUKAT_ADALET_CONFIG; const page = theme.pages[0]!; const business = AVUKAT_ADALET_BUSINESS
  return (
    <div lang="tr">
