...
import {
  ...
  ThemeRenderer, FITNESS_PILATES_CONFIG, FITNESS_PILATES_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _csg; void _tpc; void _mp; void _tbf
export default function Client() {
  const theme = FITNESS_PILATES_CONFIG; const page = theme.pages[0]!; const biz = FITNESS_PILATES_BUSINESS
