...
import {
  ...
  ThemeRenderer, ORGANIK_VEGAN_CONFIG, ORGANIK_VEGAN_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _psg; void _nfc; void _fsr; void _ocf

export default function OrganikVeganClient() {
  const theme = ORGANIK_VEGAN_CONFIG; const page = theme.pages[0]!; const business = ORGANIK_VEGAN_BUSINESS
  return (
    <div lang="tr">
