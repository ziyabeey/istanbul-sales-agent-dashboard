...
import {
  ...
  ThemeRenderer, PEYZAJ_KLASIK_CONFIG, PEYZAJ_KLASIK_BUSINESS,
} from '@kepenk/templates'
void _h; void _f; void _wa; void _c; void _ppg; void _lp; void _gsr; void _gcf

export default function PeyzajKlasikClient() {
  const theme = PEYZAJ_KLASIK_CONFIG; const page = theme.pages[0]!; const business = PEYZAJ_KLASIK_BUSINESS
  return (
    <div lang="tr">
