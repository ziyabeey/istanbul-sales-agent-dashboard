                ...
                >
                    <div className="mx-auto max-w-5xl bg-background p-6 rounded-2xl shadow-2xl border border-border/20 pointer-events-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="text-muted-foreground text-sm text-balance">
                            ...
                            <Link href="/gizlilik" className="text-primary hover:underline underline-offset-2">
                                Gizlilik Politikamızı
                            </Link>{' '}
                            ve{' '}
                            <Link href="/kvkk" className="text-primary hover:underline underline-offset-2">
                                KVKK Metnimizi
                            </Link>{' '}
                        ...
                        <div className="flex-shrink-0 w-full sm:w-auto">
                            <button
                                ...
                                className="w-full sm:w-auto bg-primary hover:bg-indigo-light text-white font-syne font-bold px-8 py-3 rounded-xl transition-colors cursor-pointer whitespace-nowrap"
                            >
