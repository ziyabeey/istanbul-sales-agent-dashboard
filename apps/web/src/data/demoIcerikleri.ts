...
const genelDemo: DemoIcerik = {
  ...
  adres: 'Sinanpaşa Mah. Ortabahçe Cad. No:15, Beşiktaş, İstanbul',
  heroBaslik: 'Sektörünüzün Lideri Olun',
  heroSlogan: 'Müşteri memnuniyeti odaklı profesyonel hizmet anlayışımızla, işletmenizi bir adım öne taşıyoruz.',
  ctaBirincil: 'Hemen Ara',
  ctaIkincil: 'WhatsApp\'tan Yazın',
  hizmetlerHtml: `
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div style="font-size:2rem">⭐</div><h3 style="font-size:1rem;font-weight:700">Profesyonel Danışmanlık</h3><p style="color:var(--renk-alt);font-size:0.85rem;line-height:1.6">Alanında uzman kadromuzla ihtiyacınıza özel çözümler üretiyoruz.</p></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div style="font-size:2rem">🕐</div><h3 style="font-size:1rem;font-weight:700">Hızlı ve Güvenilir Teslimat</h3><p style="color:var(--renk-alt);font-size:0.85rem;line-height:1.6">Zamanında teslim, eksiksiz hizmet — söz verdiğimiz tarihe sadık kalırız.</p></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div style="font-size:2rem">🛡️</div><h3 style="font-size:1rem;font-weight:700">Garanti ve Destek</h3><p style="color:var(--renk-alt);font-size:0.85rem;line-height:1.6">Tüm hizmetlerimize yazılı garanti ve satış sonrası teknik destek sunuyoruz.</p></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div style="font-size:2rem">💬</div><h3 style="font-size:1rem;font-weight:700">7/24 İletişim</h3><p style="color:var(--renk-alt);font-size:0.85rem;line-height:1.6">WhatsApp, telefon veya e-posta ile bize her an ulaşabilirsiniz.</p></div>`,
  nedenBizHtml: `
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">🏆</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">10+ Yıl Sektör Deneyimi</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">Yılların birikimi ve binleri aşan başarılı projeyle hizmetinizdeyiz.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">💰</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">Şeffaf Fiyatlandırma</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">İşe başlamadan detaylı teklif sunuyoruz; gizli maliyet yok, sürpriz fatura yok.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">⭐</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">4.9 Google Puanı</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">800+ müşteri değerlendirmesiyle bölgenin en çok tercih edilen işletmesiyiz.</p></div></div>`,
  yorumlarHtml: `
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"İşlerini çok profesyonel yapıyorlar. Söyledikleri gün, söyledikleri fiyatta teslim ettiler. Kesinlikle tavsiye ederim."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Ahmet Y.</span><span style="color:var(--renk-alt);font-size:0.75rem">1 hafta önce</span></div></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"WhatsApp'tan ulaştım, çok hızlı dönüş yaptılar. İlgi ve alakaları gerçekten mükemmel."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Seda T.</span><span style="color:var(--renk-alt);font-size:0.75rem">2 hafta önce</span></div></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"Uzun süredir aradığım güvenilir hizmet burada. Fiyat-performans dengesi çok iyi, her işlerinde titizler."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Murat K.</span><span style="color:var(--renk-alt);font-size:0.75rem">1 ay önce</span></div></div>`,
  seoBaslik: 'Örnek İşletme | Beşiktaş\'da Profesyonel Hizmet',
  seoAciklama: 'Beşiktaş\'ta 10 yılı aşkın deneyimle profesyonel hizmet. Müşteri memnuniyeti garantisi, şeffaf fiyatlandırma ve 7/24 destek.'
}
...
const otelDemo: DemoIcerik = {
  ...
  nedenBizHtml: `
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">🏆</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">5 Yıldızlı Hizmet</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">Uluslararası standartlarda misafirperverlik ve 24 saat concierge.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">📍</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">Merkezi Konum</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">Taksim'e 5 dk, Galata Kulesi'ne yürüme mesafesinde eşsiz konum.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">⭐</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">9.4 Booking Puanı</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">2.500+ misafir değerlendirmesiyle Beyoğlu'nun en beğenilen oteli.</p></div></div>`,
  yorumlarHtml: `
    ...
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"SPA merkezi inanılmazdı, özellikle Türk hamamı deneyimi unutulmazdı. Personel çok ilgili ve güleryüzlü."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Kemal A.</span><span style="color:var(--renk-alt);font-size:0.75rem">2 hafta önce</span></div></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"İş seyahati için konakladık, teras restoranın manzarası ve yemekleri olağanüstüydü. Kurumsal toplantı salonları da çok profesyonel."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Deniz M.</span><span style="color:var(--renk-alt);font-size:0.75rem">1 ay önce</span></div></div>`,
...
const marketDemo: DemoIcerik = {
  ...
  nedenBizHtml: `
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">🌿</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">%100 Taze Garantisi</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">Her sabah halden taze gelen ürünler — memnun kalmazsanız koşulsuz iade.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">🚚</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">1 Saatte Eve Teslimat</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">WhatsApp'tan liste gönderin, 1 saat içinde kapınızda. 150₺ üzeri ücretsiz.</p></div></div>
    <div style="display:flex;gap:14px;align-items:flex-start;padding:16px;background:rgba(255,255,255,0.04);border-radius:14px;border:1px solid rgba(255,255,255,0.06)"><div style="width:42px;height:42px;border-radius:12px;background:var(--renk-vurgu);opacity:0.9;display:flex;align-items:center;justify-content:center;font-size:1.3rem;flex-shrink:0">🏪</div><div><h3 style="font-size:0.95rem;font-weight:700;margin-bottom:4px">30 Yıllık Mahalle Bakkalı</h3><p style="color:var(--renk-alt);font-size:0.82rem;line-height:1.5">1995'ten beri Çengelköy'ün güvenilir adresi. Müşterilerimizi tanır, ihtiyaçlarını biliriz.</p></div></div>`,
  yorumlarHtml: `
    ...
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"Yöresel ürünleri başka hiçbir yerde bulamıyorum. Karadeniz tereyağı ve köy peyniri gerçekten orijinal."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Fatih G.</span><span style="color:var(--renk-alt);font-size:0.75rem">1 hafta önce</span></div></div>
    <div class="kart" style="display:flex;flex-direction:column;gap:12px"><div>⭐⭐⭐⭐⭐</div><p style="color:var(--renk-metin);font-size:0.9rem;line-height:1.6">"Yıllardır alışveriş yapıyorum, bir kez bile sorun yaşamadım. Ürün taze değilse anında değiştiriyorlar."</p><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-weight:700;font-size:0.85rem">Elif A.</span><span style="color:var(--renk-alt);font-size:0.75rem">2 hafta önce</span></div></div>`,
