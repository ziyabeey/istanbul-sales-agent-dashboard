(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,779821,e=>{"use strict";var t=e.i(228434);let a=["TEMEL","STANDART","BUYUME","PREMIUM","PREMIUMPLUS"];function i(e,t){let i=n.find(t=>t.id===e);return!!i&&a.indexOf(t)>=a.indexOf(i.minPaket)}function r(e,a){let r=(0,t.sektorBul)(e);return r?r.moduller.map(e=>n.find(t=>t.id===e)).filter(e=>!!e&&i(e.id,a)):[]}let n=[{id:"iletisim-formu",ad:"İletişim Formu",aciklama:"Ziyaretçi mesaj gönderebilir, WhatsApp'a iletilir",minPaket:"TEMEL",htmlBlok:"İletişim formu bölümü — ad, telefon, mesaj, WhatsApp'a gönder butonu",geminiTalimat:"Site sonuna iletişim formu ekle. Form alanları: Ad Soyad, Telefon, Mesaj. Gönder butonu wa.me linki açsın.",htmlSablon:`<section id="iletisim" style="padding:100px 20px; background:var(--renk-kart); position:relative; overflow:hidden;">
...
</script>`}];e.s(["MODULLER",0,n,"esnafModulleri",()=>r,"modulKullanilabilir",()=>i])}]);