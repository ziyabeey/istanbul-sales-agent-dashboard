...
const useEditorStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$zustand$40$5$2e$0$2e$11_$40$types$2b$react$40$19$2e$2$2e$14_immer$40$11$2e$1$2e$4_react$40$19$2e$2$2e$3_use$2d$sync$2d$external$2d$store$40$1$2e$6$2e$0_react$40$19$2e$2$2e$3_$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        applyInlineEdit: (text)=>set((s)=>{
                if (!s.inlineEdit || !s.siteData) return s;
                const field = s.inlineEdit.field;
...
function Canvas() {
    ...
    const openInlineEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$apps$2f$web$2f$src$2f$app$2f$dashboard$2f$sitem$2f$editor$2f$store$2f$editor$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEditorStore"])({
        "Canvas.useEditorStore[openInlineEdit]": (s)=>s.openInlineEdit
    }["Canvas.useEditorStore[openInlineEdit]"]);
    ...
    const closeInlineEdit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$apps$2f$web$2f$src$2f$app$2f$dashboard$2f$sitem$2f$editor$2f$store$2f$editor$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEditorStore"])({
        "Canvas.useEditorStore[closeInlineEdit]": (s)=>s.closeInlineEdit
    }["Canvas.useEditorStore[closeInlineEdit]"]);
        ...
        "Canvas.useEffect": ()=>{
            const handler = {
                "Canvas.useEffect.handler": (e)=>{
                    ...
                    if (e.data.type === 'ke-inline-edit') {
                        const x = offsetX + e.data.x * zoomFactor;
                        const y = offsetY + e.data.y * zoomFactor;
                        openInlineEdit({
                            x,
                            y,
                            width: Math.max(e.data.width * zoomFactor, 260),
                            field: e.data.field,
                            text: e.data.text,
...
_s(Canvas, "QTsIZvXI3wfn3QW+qSQGveFnXfU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$apps$2f$web$2f$src$2f$app$2f$dashboard$2f$sitem$2f$editor$2f$store$2f$editor$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEditorStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$apps$2f$web$2f$src$2f$app$2f$dashboard$2f$sitem$2f$editor$2f$store$2f$editor$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEditorStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$apps$2f$web$2f$src$2f$app$2f$dashboard$2f$sitem$2f$editor$2f$store$2f$editor$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEditorStore"],
 ...
 * A mini floating toolbar appears above the element for quick formatting.
...
(function() {
    ...
    const IMG_TAGS = new Set(['IMG','SVG','VIDEO']);
    ...
    toolbar.innerHTML = \`
        ...
        <button onclick="__keAction('done')" class="done" title="Kaydet (Enter)">✓ Tamam</button>
        <div class="sep"></div>
        <button onclick="__keAction('cancel')" class="cancel" title="İptal (Esc)">✕</button>
    \`;
    ...
    // Click on text → start inline editing
    document.addEventListener('click', function(e) {
        ...
        if (TEXT_TAGS.has(el.tagName)) {
            ...
            // Clicked non-text → finish current edit
    ...
    document.addEventListener('contextmenu', function(e) {
        ...
        window.parent.postMessage({
            ...
            x: e.clientX,
            y: e.clientY,
            targetType: TEXT_TAGS.has(el.tagName) ? 'text' : IMG_TAGS.has(el.tagName) ? 'image' : 'generic',
    ...
    console.log('[Kepenk Editor] Inline editing active');
})();
<\/script>`;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function ContextMenu() {
    ...
    /* Close on outside click or Escape */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    /* Keep menu within viewport */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ContextMenu.useEffect": ()=>{
    ...
    const isImage = contextMenu.targetType === 'image';
    ...
    const handleCopy = ()=>{
        if (contextMenu.targetText) {
            navigator.clipboard.writeText(contextMenu.targetText).catch(()=>{});
        }
        closeContextMenu();
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("style", {
                ...
                @keyframes keCtxIn { from { opacity: 0; transform: scale(0.95) translateY(-4px); } to { opacity: 1; transform: none; } }
                .ke-ctx-item {
                ...
                .ke-ctx-item:hover { background: #f1f5f9; color: #17191c; }
                .ke-ctx-item.primary:hover { background: #eff6ff; color: #2563eb; }
                .ke-ctx-item.destructive:hover { background: #fef2f2; color: #ef4444; }
                .ke-ctx-item-icon { width: 18px; text-align: center; font-size: 14px; flex-shrink: 0; }
                .ke-ctx-item-label { flex: 1; }
                .ke-ctx-item-shortcut { font-size: 11px; color: #94a3b8; font-weight: 600; }
                .ke-ctx-sep { height: 1px; background: #e8ecf1; margin: 4px 6px; }
                .ke-ctx-header { padding: 6px 14px 4px; font-size: 10px; font-weight: 800; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.06em; }
            `
            }, void 0, false, {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                isText ? `📝 ${contextMenu.targetTag.toUpperCase()}` : isImage ? '🖼️ Görsel' : '📦 Element',
                                contextMenu.targetText && ` — "${contextMenu.targetText.slice(0, 25)}${contextMenu.targetText.length > 25 ? '…' : ''}"`
                            ]
                        }, void 0, true, {
                            fileName: "[project]/XinXia/apps/web/src/app/dashboard/sitem/editor/components/ContextMenu.tsx",
                            lineNumber: 106,
                        ...
                        hasField && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "ke-ctx-item-shortcut",
                                    children: "Tıkla"
                                }, void 0, false, {
                                    fileName: "[project]/XinXia/apps/web/src/app/dashboard/sitem/editor/components/ContextMenu.tsx",
                                    lineNumber: 116,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            className: "ke-ctx-item",
                            onClick: ()=>{
                                console.log('Element path:', contextMenu.elementPath);
                                closeContextMenu();
                            },
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$XinXia$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_$40$opentelemetry$2b$api$40$1$2e$9$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=XinXia_apps_web_src_32699485._.js.map