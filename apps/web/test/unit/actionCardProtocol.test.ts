...
describe('Action Card outcome contract', () => {
  it('requires executionRef for an executed command outcome', () => {
    expect(ActionCardOutcomeEventSchema.safeParse({
      protocolVersion: '1',
      outcomeId: 'outcome-1',
      cardId: 'card-1',
      cardRevision: 1,
      ...
      occurredAt: '2026-09-24T17:02:00+03:00',
      actionId: 'fill-gap',
    }).success).toBe(false)
  })

  it('accepts a verified execution outcome reference', () => {
    expect(ActionCardOutcomeEventSchema.safeParse({
      protocolVersion: '1',
      outcomeId: 'outcome-2',
      cardId: 'card-1',
