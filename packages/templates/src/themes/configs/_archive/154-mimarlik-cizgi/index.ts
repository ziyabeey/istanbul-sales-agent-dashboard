...
export const MIMARLIK_CIZGI_BUSINESS = {
  name: 'Mimarlık Ofisi',
  ownerName: 'Mimarlık Ofisi Sahibi',
  sectorId: 'mimarlik',
  slogan: 'Profesyonel hizmet, güvenilir kalite',
  phone: '0532 000 00 00',
  phoneClean: '905320000000',
  whatsapp: '905320000000',
  email: 'info@mimarlik-cizgi.com',
  address: 'İstanbul',
  city: 'İstanbul',
  district: 'Kadıköy',
  socialMedia: { instagram: 'https://instagram.com/mimarlik-cizgi' },
  photos: [],
...
export const MIMARLIK_CIZGI_CONFIG: ThemeConfig = { 
  id: 'mimarlik-cizgi', 
  name: 'Mimarlık Ofisi', 
  sectorId: 'mimarlik', 
  plan: 'free', 
  isDark: false, 
  cssVariables: { '--color-bg': '#FFFFFF', '--color-surface': '#F8FAFC', '--color-text': '#0F172A', '--color-accent': '#3969ac',
    '--color-accent-light': '#e8f1fc',
    '--color-accent-hover': '#2f568e',
    '--color-accent-active': '#2a4d7e', '--color-text-on-accent': '#FFFFFF', '--color-border': '#E2E8F0', '--font-heading': "'Inter', sans-serif", '--font-body': "'Inter', sans-serif" }, 
  fonts: { 
    heading: { family: 'Inter', subsets: ['latin'], weights: [700] }, 
    ...
    globalSections: [
    {
      ...
      defaultContent: {
        logo: { type: 'text', text: 'Mimarlık Ofisi' },
    ...
    },
    {
      ...
      defaultContent: {
        businessName: 'Mimarlık Ofisi',
        copyright: '© 2026 Mimarlık Ofisi',
        poweredBy: 'kepenk.ai',
      },
      editableFields: [],
    },
  ...
  description: 'Temel mimarlık projeleri ve çizim hizmetleri.',
  seoSchemaType: 'ProfessionalService',
  sectorSections: [],
  designPhilosophy: 'Clean geometric lines.',
  performanceBudget: { maxJS: '100kb', maxLCP: '2.0s', animationLevel: 'framer-basic' },
  pages: [{ 
    id: 'anasayfa', 
    slug: '/', 
    title: 'Mimari Tasarım', 
    titleTr: 'Mimari Tasarım',
    isHomePage: true, 
    includeInNav: false, 
    sections: [
