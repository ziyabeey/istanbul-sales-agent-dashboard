...
# Kepenk web + BFF üretim paketi. Eski /demolar ve site editörü kaynakta
# korunur; eksik legacy tema bağımlılıkları giderilene kadar imaja girmez.
RUN node scripts/build-kepenk-web-cloud-run.mjs
